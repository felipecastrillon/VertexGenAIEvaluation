...
def test_data_class():
  ...
  model_instance =  models.PalmBisonModel(parameters = {"temperature":0.2,
                                                ...
                                                "top_p":0.8,
                                                "max_output_tokens":1000}  )
  data_instance = data.Data("summarization_sample.jsonl", prefix, "article", "summary")
...
def test_classification_evaluator():
  ...
  model_instance =  models.PalmBisonModel(parameters = {"temperature":0.0,
                                                ...
                                                "top_p":0.8,
                                                "max_output_tokens":5}  )
  data_instance = data.Data("classification_sample.csv", prefix, "Description", "Category")
  data_instance.generate_model_responses(model_instance)
...
def test_extraction_evaluator():
  ...
  data_instance = data.Data("extraction_sample.csv", prefix, "Question", "Answer")
  data_instance.generate_model_responses(model_instance)
